...
import { Layout, Menu, Button, Space, Typography, Card, Row, Col, Statistic, theme, ConfigProvider } from 'antd';
import { 
  DashboardOutlined, 
  UploadOutlined, 
  BarChartOutlined, 
...
function App() {
  ...
  useEffect(() => {
    ...
    const fetchSystemData = async () => {
      try {
        ...
        setSystemHealth({ status: 'healthy', services: { models: 'loaded' } });
        setStats({
  ...
  const getConnectionBadge = () => {
    switch (connectionStatus) {
      ...
      case 'disconnected':
        return <Badge status="error" text="Demo Mode" />;
      default:
